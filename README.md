![jcenter](https://img.shields.io/badge/_jcenter_-0.0.0.17.2-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-29/29-green.png?style=flat)
# Asynk Server
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/asynk/server/0.0.0.17.2/server-0.0.0.17.2.jar) the latest jar.
...
```gradle
dependencies {
  compile 'info.jdavid.asynk:server:0.0.0.17.2'
}
```

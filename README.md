![jcenter](https://img.shields.io/badge/_jcenter_-0.0.0.5-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-34/34-green.png?style=flat)
# server
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/asynk/server/0.0.0.5/server-0.0.0.5.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.asynk:server:0.0.0.5'
}
```

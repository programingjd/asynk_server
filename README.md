![jcenter](https://img.shields.io/badge/_jcenter_-0.0.0.24-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-31/31-green.png?style=flat)
# Asynk Server
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/asynk/server/0.0.0.24/server-0.0.0.24.jar) the latest jar.
...
```gradle
dependencies {
  compile 'info.jdavid.asynk:server:0.0.0.24'
}
```

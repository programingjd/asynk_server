![jcenter](https://img.shields.io/badge/_jcenter_-0.0.0.31-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-34/34-green.png?style=flat)
# Asynk Server
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/asynk/server/0.0.0.31/server-0.0.0.31.jar) the latest jar.
...
```gradle
dependencies {
  compile 'info.jdavid.asynk:server:0.0.0.31'
}
```
